...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content: 'My husband surprised me with the Romantic Aurora Retreat for our 10th anniversary. Watching the Northern Lights from our private hot tub was absolutely breathtaking. The private husky safari was so special - just the two of us gliding through the snow. Every detail was perfect. This is the most romantic trip we\'ve ever taken.',
    packageName: 'Romantic Aurora Retreat',
  ...
  },
  {
    ...
    content: 'We specifically wanted to see the Northern Lights and Lapland Famille delivered. Our guide was incredibly knowledgeable and took us to the perfect spot. We saw the most amazing aurora display for over an hour. The glass cabin meant we could watch from our warm bed too! The whole experience was first class.',
    packageName: 'Romantic Aurora Retreat',
